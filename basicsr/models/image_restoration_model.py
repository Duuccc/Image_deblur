...
class ImageRestorationModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        # define network take network_g in configuration file (.yml)
    ...
    #prepares input for training step
    def feed_data(self, data, is_val=False):
        self.lq = data['lq'].to(self.device)
        if 'gt' in data:
            self.gt = data['gt'].to(self.device)

    #divides a large input image into smaller crops
    def grids(self):
    ...
    #reconstructs full image from the crop patches
    ...
    #applying pixel and perceptual loss and updates the generator parameters using optimizer
